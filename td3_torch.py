...
class Agent:
    ...
    def __init__(self, actor_learning_rate, critic_learning_rate, input_dims, tau, env, gamma=0.99, update_actor_interval=2, warmup=3000,
                 n_actions=2, max_size=1000000, layer1_size=256, layer2_size=128, batch_size=100, noise=0.4):
    ...
    def learn(self):
        ...
        next_state = T.tensor(next_state, dtype=T.float32).to(self.critic_1.device)
    ...
    def update_network_parameters(self, tau=None):
        ...
        critic_1_state_dict = dict(critic1_params)
        critic_2_state_dict = dict(critic2_params)
        ...
        for name in critic_1_state_dict:
            critic_1_state_dict[name] = tau * critic_1_state_dict[name].clone() + (1-tau) * target_critic1_state_dict[name].clone()

        for name in critic_2_state_dict:
            critic_2_state_dict[name] = tau * critic_2_state_dict[name].clone() + (1-tau) * target_critic2_state_dict[name].clone()
